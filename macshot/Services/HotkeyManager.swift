...
class HotkeyManager {
    ...
    func registerAll(captureArea: @escaping () -> Void, captureFullScreen: @escaping () -> Void, captureOCR: @escaping () -> Void, quickCapture: @escaping () -> Void, scrollCapture: @escaping () -> Void, openFromClipboard: @escaping () -> Void) {
        unregisterAll()
